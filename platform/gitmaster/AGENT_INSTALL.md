...
|---|---|
| Release | `wzser/supermatrix`, tag `v0.3.3`; never `latest` or `main` |
| Archive | `supermatrix-v0.3.3.tar`, asset of that exact Release |
...
| Public snapshot commit | Resolve the exact annotated `v0.3.3` tag to its commit and record it; the release title or target branch alone is not a commit receipt |
| Framework source provenance | Record the frozen source commit declared in the verified archive's `SANITIZATION_REPORT.md` |
| Archive prefix | `supermatrix-v0.3.3/` |
...
| `PACKAGE_ROOT` | `INSTALL_ROOT/package/supermatrix-v0.3.3` after verified extraction |
...
```json
{"document_version":"1.2.0","release_tag":"v0.3.3","archive_sha256":"<verified-release-asset-sha256>","runtime_root":"/Users/LOCAL_USER/.local/share/supermatrix-agent-v1/runtime","profile":"agent-install-v1","backend":"codex","api_port":3511,"scheduler_port":3512,"last_completed_step":"S2"}
```
