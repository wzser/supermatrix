...
- Input: AGENT_INSTALL.md version 1.2.0; the v0.3.3 pilot must pass S1 with matching published metadata and assets. Do not pair this revision with the old 1.0.1 candidate. Sample: `{"document_version":"1.2.0","release_tag":"v0.3.3","backend":"codex","package_status":"awaiting_S1_verification"}`.
...
- Draft SOP registration is intentional while full live acceptance remains unverified. Document 1.2.0 is a versioned agent-operated runbook for the v0.3.3 pilot. Earlier 1.0.1 approval does not certify these inputs; require this version's package report and S1 readback.
