...
|---|---|---|---|---|---|
| [SOP-daily-commit-judgment-matrix-active-20260821-1a186q.md](SOP-daily-commit-judgment-matrix-active-20260821-1a186q.md) | active | 2026-08-21 | localgit | 判定「某仓某文件该不该被 daily-commit 自动提交」；本地私有数据与飞书标识可提交，time-budget 尾部重审后才进入内容路由 | 上游：runtime sessions 治理选择 / daily-commit 主循环 / skip-handling owner delegation；下游：git-ledger、hold_review、repo-policies manifest；类目目录引用 references/daily-commit-ignore-policy.md |
...
| [SOP-daily-commit-skip-handling-active-20260821-3wa4uu.md](SOP-daily-commit-skip-handling-active-20260821-3wa4uu.md) | active | 2026-08-21 | localgit | daily-commit 后分类 skipped、执行单轮容量重审、派发内容性 owner delegation、处理 hold_review 并记录裁决 | 上游：daily-commit 运行结果 / committed_hold；下游：dispatches / decisions、hold-decision、FP escalation、周裁决 digest |
