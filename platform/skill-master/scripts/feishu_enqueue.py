...
WENDANGWANG_ROOT = Path(
    os.environ.get("WENDANGWANG_ROOT", str(ROOT.parent / "wendangwang")
)).expanduser()
ENQUEUE = Path(
    os.environ.get("FEISHU_SYNC_ENQUEUE", str(WENDANGWANG_ROOT / "bin/feishu-sync-enqueue"))
).expanduser()
