...
```
bash /Users/LOCAL_USER/SuperMatrixRuntime/workspaces/skill-master/scripts/record-tick.sh excalidraw-diagram
```
...
```bash
cd /Users/LOCAL_USER/SuperMatrixRuntime/workspaces/skill-master/skills/excalidraw-diagram/references && uv run python render_excalidraw.py <path-to-file.excalidraw>
```
...
```bash
cd /Users/LOCAL_USER/SuperMatrixRuntime/workspaces/skill-master/skills/excalidraw-diagram/references
uv sync
