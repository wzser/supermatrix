...
const expectedNetInput = Math.max(0, usageEvent.inputTokens - usageEvent.cacheReadTokens);
if (row.input_tokens !== expectedNetInput || row.output_tokens !== usageEvent.outputTokens) {
