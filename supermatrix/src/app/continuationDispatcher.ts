 ...
 * an InboundMessage with framework_synthetic origin and a structured system
 * envelope (XML-ish), then feed it into the existing dispatcher so the
 * parent's normal run pipeline processes it as prompt text.
 *
