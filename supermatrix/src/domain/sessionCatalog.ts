...
// One flat record per addressable active work session. Every field a router needs
...
// addressable-session scope: child sessions are internal execution units and
// deleted rows are gone, while fpManaged is projected as governance metadata
// instead of deciding addressability. Entries are sorted by name so
// regeneration produces a stable, diff-friendly file.
