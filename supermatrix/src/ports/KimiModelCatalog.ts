// Verified against Kimi Code CLI 0.41.0 (2026-09-05) via `kimi provider list
// --json` plus live `kimi -m <slug> -p` probes: the managed kimi-code
// provider serves kimi-for-coding, -highspeed, k3 and k3-256k.
...
export const KIMI_K3_256K_MODEL = "kimi-code/k3-256k";
...
const KIMI_MODEL_CATALOG: readonly KimiModelEntry[] = [
  ...
  { slug: KIMI_K3_256K_MODEL, thinking: K3_THINKING },
];
