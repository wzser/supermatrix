...
Synthetic fixtures matching the codex exec --json format (as implemented by the old feishu project's streamParser at /Users/LOCAL_USER/feishu/src/control-plane/codex/streamParser.ts).
