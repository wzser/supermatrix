...
describe("CodexModelCatalog effort support", () => {
  ...
  test("bundled catalog preserves the complete GPT-6-Astra effort matrix", () => {
    setCodexModelCatalogEntries(
      [{
        slug: "gpt-6-astra",
    ...
    expect(getCodexSupportedEfforts("gpt-6-astra")).toEqual([
      "low",
      "medium",
      "high",
      "xhigh",
    ...
    expect(formatCodexEffortMatrix()).toBe(
